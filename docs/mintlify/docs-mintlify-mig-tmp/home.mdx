...
- **connect your apps** — dozens of integrations: Slack, Notion, Gmail, Obsidian, Toggl, HubSpot, Salesforce, Zoom, PostHog, Sentry, and more ([connections](/connections)) — configure in **settings → connections**
