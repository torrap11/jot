...
## proactive recall (parthha12 fork)

This tree is **[Screenpipe](https://github.com/screenpipe/screenpipe)** merged with proactive-recall research and build prompts.

| Step | Action |
|------|--------|
| Setup | `./scripts/setup-dev.sh` (installs app deps; fixes Tailwind IntelliSense) |
| Run Screenpipe | See **[PROACTIVE_RECALL.md](PROACTIVE_RECALL.md)** |
| Implement recall | Paste **`docs/proactive-recall/prompts/00-START.md`** in Claude Code |
