...
<Warning>
HTTP MCP can expose screen history to whatever can reach the server. keep it on trusted machines and networks, and do not bind it publicly unless you know exactly how it is protected.
</Warning>
